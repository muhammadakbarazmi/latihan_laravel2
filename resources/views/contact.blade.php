...
@section('content')
    <div class="row tm-welcome-content">
      <h2 class="white-text tm-handwriting-font tm-welcome-header"><img src="{{asset('template')}}/img/header-line.png" alt="Line" class="tm-header-line">&nbsp;Contact Us&nbsp;&nbsp;<img src="{{asset('template')}}/img/header-line.png" alt="Line" class="tm-header-line"></h2>
